    ...
    <div class="container-scroller">
        ...
        <nav class="navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
            <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center">
                <x-ionicon-car-outline class="logo" />
        <p class="debdi">HICHAM-GARAGE</p>
        <style>
        .debdi{
        ...
        <div class="container-fluid page-body-wrapper">
                    ...
                    <div class="tab-pane fade" id="chats-section" role="tabpanel" aria-labelledby="chats-section">
                        ...
                        <ul class="chat-list">
                            <li class="list active">
                                <div class="profile"><img src={{ asset('images/faces/Capture.PNG') }}
            ...
            <nav class="sidebar sidebar-offcanvas" id="sidebar">
                <ul class="nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" data-toggle="collapse" href="{{ route('clients.index') }}"
                    ...
                    <li class="nav-item">
                        <a class="nav-link" data-toggle="collapse" href="#tables" aria-expanded="false"
                            ...
                            <span class="menu-title">Reparations</span>
                    ...
                    <li class="nav-item">
                        <a class="nav-link" data-toggle="collapse" href="{{ route('layouts.stock') }}"
                    ...
                    <li class="nav-item">
                        <a class="nav-link" data-toggle="collapse" href="{{ route('vehicules.index') }}"
                        ...
                        <div class="col-md-12 grid-margin">
                            <div class="row">
                                <div class="col-12 col-xl-8 mb-4 mb-xl-0">
                                    ...
                                    <h6 class="font-weight-normal mb-0">IN HICHAM-GARAGE !!</h6>
                                </div>
                    ...
                    <div class="row">
                        <div class="col-md-6 ">
                            <div class="card tale-bg">
                                <div class="card-people mt-10">
                                    <img src={{ asset('images/faces/ha.PNG') }} alt="people">
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-4 stretch-card transparent">
                                    <div class="card card-tale">
                                        <div class="card-body">
                                            <p class="mb-4">NOMBRE DES CLIENTS</p>
                                            <p class="fs-30 mb-2"> {{ $clientCount }} Clients</p>
                                ...
                                <div class="col-md-6 mb-4 stretch-card transparent">
                                    <div class="card card-dark-blue">
                                        <div class="card-body">
                                            <p class="mb-4">NOMBRE DES MECHANICHIEN</p>
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-4 mb-lg-0 stretch-card transparent">
                                    <div class="card card-light-blue">
                                        <div class="card-body">
                                            <p class="mb-4">NOMBRE DES VEHICULES</p>
                                            <p class="fs-30 mb-2">{{ $vehiculeCount}}  Vehicules</p>
                                ...
                                <div class="col-md-6 stretch-card transparent">
                                    <div class="card card-light-danger">
                                        <div class="card-body">
                                            <p class="mb-4">Archive de stock</p>
                                            <p class="fs-30 mb-2">{{$stockCount}}</p>
