<form onsubmit="" action="{{ route('vehicule.ConfirmUpdate') }}" id="modifyVehicle" style="width: 600px;height:600px" method="POST" enctype="multipart/form-data" class="flex flex-col border p-2 ps-2 items-center gap-10 justify-evenly">
    ...
    <div class="flex flex-row w-full gap-10 justify-evenly">
        <div class="">
            <label for="marque" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Mark</label>
    ...
    <div class="flex flex-row w-full gap-10 justify-evenly">
        <div class="">
            <label for="typeCarburant" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Fuel type</label>
            <input style="height: 35px" type="text" name="typeCarburant" value="{{ $vehicule->typeCarburant }}"
                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-64 p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                required />
        </div>
        <div>
            <label for="immatriculation" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Registration number</label>
    ...
    <div class="flex flex-row w-full gap-10 justify-evenly">
        <div class="">
            <label for="photos" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Photo</label>
